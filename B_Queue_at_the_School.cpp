...
template<typename T>
istream& operator>>(istream &istream,vector<T>&v){for(int i=0;i<v.size();i++) cin>>v[i]; return istream;}
template<typename T>
ostream& operator<<(ostream &ostream,vector<T>&v){for(int i=0;i<v.size();i++) cout<<v[i]<<" "; return ostream;}
